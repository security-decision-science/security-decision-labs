...
> A collection of educational tools for evidence-based security decision-making

Part of [Security Decision Science](https://github.com/security-decision-science) - 
turning security data into decisions through Monte Carlo, Bayes, Survival Analysis, 
